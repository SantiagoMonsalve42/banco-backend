...
public class ClienteDTO extends PersonaDTO{
    ...
    public ClienteDTO(Integer id, String primer_nombre, String segundo_nombre, String primer_apellido, String segundo_apellido, String email, LocalDateTime fechaAlta, LocalDateTime fechaModificacion, Direccion direccion, Telefono telefono, TipoCliente tipo_cliente) {
